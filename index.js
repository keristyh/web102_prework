...
const displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded}
...
nameElem.innerHTML = `${firstGame.name}`;
firstGameContainer.append(nameElem);

// do the same for the runner up item
const name2Elem = document.createElement("p");
name2Elem.innerHTML = `${secondGame.name}`;
secondGameContainer.append(name2Elem);